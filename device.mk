...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/configs/android-removed-permissions.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android-removed-permissions.xml
...
# init
$(call soong_config_set,libinit,vendor_init_lib,//$(DEVICE_PATH):init_nabu)
